...
<body style="background: /*#ffcccc*/;
	...
	<h1 style="text-align: center">Hitung Perkalian</h1>
	...
	<br>
	<center>
	<button type="submit" class="btn btn-outline-secondary"><i class = "material-icons" style="text-align: center;"><?php echo $submit; ?></button>
	</center>
	<?php echo form_close();?>
